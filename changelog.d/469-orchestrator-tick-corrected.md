...
- The harvest acts belong to the seats that own them: exchange belongs to a dispatch that produced a branch, and a verdict is derived only from a completed review dispatch.
