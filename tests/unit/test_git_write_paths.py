"""Tests for the conservative Git write-target reader (#673)."""
...
def test_unbounded_git_shapes_are_unreadable(words: list[str]) -> None:
...
@pytest.mark.parametrize(
    "words",
    [["cd"], ["cd", "-"], ["cd", "$OTHER", "extra"], ["pushd", str(OTHER)]],
)
